...
if ( ! function_exists( 'spacious_breadcrumb' ) ) :
	...
	function spacious_breadcrumb() {
		if ( function_exists( 'bcn_display' ) ) {
			...
			echo '<span class="breadcrumb-title">' . __( 'Du er her: ', 'spacious' ) . '</span>';
			bcn_display();
...
if ( ! function_exists( 'spacious_main_nav' ) ) :
	function spacious_main_nav() {
		...
		<nav id="site-navigation-edit" class="main-navigation clearfix  <?php echo esc_attr( $class ); ?> <?php echo esc_attr( get_theme_mod( 'spacious_one_line_menu_setting' )) ? 'tg-extra-menus' : ''; ?>" role="navigation">
			<p class="menu-toggle">
			...
			if ( has_nav_menu( 'primary' ) ) {
				wp_nav_menu( array(
					...
					'container_class' => 'menu-primary-container-edit',
				) );
			} else {
				wp_page_menu();
			}
